...
#Region "Код, автоматически созданный конструктором форм Windows "
	...
	<System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
		...
		Me.lblDescription.Text = "Определитель смен при двусменном четырёхдневном графике"
...
#End Region 
	...
	Private Sub frmAbout_Load(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles MyBase.Load
		...
		'UPGRADE_ISSUE: App свойство App.Revision не был обновлен. Дополнительно: 'ms-help://MS.VSCC.2003/commoner/redir/redirect.htm?keyword="vbup2069"'
		...
		Me.Top = VB6.TwipsToPixelsY(CSng(GetConfig("About", "Top", IniFile)))
		Me.Left = VB6.TwipsToPixelsX(CSng(GetConfig("About", "Left", IniFile)))
	End Sub
	...
	Public Sub StartSysInfo()
		...
		ElseIf GetKeyValue(HKEY_LOCAL_MACHINE, gREGKEYSYSINFOLOC, gREGVALSYSINFOLOC, SysInfoPath) Then 
			...
			'UPGRADE_WARNING: "Dir" имеет новое поведение. Дополнительно: 'ms-help://MS.VSCC.2003/commoner/redir/redirect.htm?keyword="vbup1041"'
...
GetKeyError: ' Cleanup After An Error Has Occured...
	...
	'UPGRADE_WARNING: Form событие frmAbout.Unload имеет новое поведение. Дополнительно: 'ms-help://MS.VSCC.2003/commoner/redir/redirect.htm?keyword="vbup2065"'
	Private Sub frmAbout_Closed(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles MyBase.Closed
		...
		conf = SaveConfig("About", "Top", CStr(VB6.PixelsToTwipsY(Me.Top)), IniFile)
		'UPGRADE_WARNING: Не удается разрешить свойство по умолчанию объекта conf. Дополнительно: 'ms-help://MS.VSCC.2003/commoner/redir/redirect.htm?keyword="vbup1037"'
		conf = SaveConfig("About", "Left", CStr(VB6.PixelsToTwipsX(Me.Left)), IniFile)
	End Sub
End Class